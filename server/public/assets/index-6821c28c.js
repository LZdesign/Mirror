(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(t){if(t.ep)return;t.ep=!0;const o=s(t);fetch(t.href,o)}})();const q=document.querySelector(".hero-banner"),f=document.querySelector(".hero-div"),c=document.querySelector(".answer");document.querySelector(".question p");const h=document.querySelector(".conversation-container"),g=document.querySelector("#textArea"),k=document.querySelector(".progress__container"),E="https://www.themirrorapp.io/questions",L=document.querySelector(".Download");document.querySelector(".interaction__container");document.querySelector(".loading-response");const y=document.querySelector(".result"),I=document.getElementById("form-container");let l=[];async function v(n,e){const i=await(await fetch(n)).text();I.innerHTML=i,e&&e()}function p(n,e){const s=document.createElement("div");s.classList.add("message",n),s.textContent=e,h.appendChild(s),h.scrollTop=h.scrollHeight}async function x(n){p("assistant",n),c.disabled=!1}async function T(n){p("assistant",n)}function m(n){const e=document.querySelector(".errorMessage"),s=document.querySelector(".errorDiv");s.style.height="auto",e.textContent=n,e.style.transform="translateY(0)",e.style.opacity="1",setTimeout(()=>{e.style.transform="translateY(-100%)",e.style.opacity="0"},2e3),setTimeout(()=>{s.style.height="0",e.textContent=""},2400)}function d(n){const e=document.querySelector(n);return e.value.trim()===""?(e.classList.add("error","shake"),e.addEventListener("animationend",()=>{e.classList.remove("error","shake")}),!1):!0}async function w(){return(await(await fetch(E,{method:"POST",headers:{"Content-type":"application/json"},body:JSON.stringify({prompt:l})})).json()).message.trim()}function D(){const n=document.querySelector(".radioBtn:checked");if(n){const e=`/assets/components/${n.value}.html`;v(e,b)}}document.querySelectorAll(".radioBtn").forEach(n=>{n.addEventListener("click",()=>{const e=`/assets/components/${n.value}.html`;v(e,b)})});D();function b(){const n=document.querySelector("button.generate-question");n&&n.addEventListener("click",async e=>{e.preventDefault();const i=e.target.getAttribute("data-btn");if(i==="self-reflect"){const o=document.querySelector("#userName").value;document.querySelector("#focusArea").value;const a=document.querySelector("#focusAreaDetail").value,u=d("#userName"),r=d("#focusArea"),S=d("#focusAreaDetail");if(!u||!r||!S){m("Please fill in the empty fields");return}l=[{role:"system",content:`Background:
...
Do not store any personal information beyond what is necessary for the continuity of coaching sessions.`},{role:"user",content:`Begin a session with '${o}', '${o}' answered to why are you seeking out coaching: '${a}'`}]}else if(i==="vant"){const o=document.querySelector("#userName").value,a=document.querySelector("#vanting").value,u=d("#vanting");if(!d("#userName")||!u){m("Please fill in the empty fields");return}l=[{role:"system",content:`Background:
You are a professional life and mental coach. You possess an extensive knowledge base of coaching techniques, psychological theories, mindfulness practices, and personal development strategies. Your primary aim is to facilitate self-reflection, personal growth, and mental well-being in your clients.
